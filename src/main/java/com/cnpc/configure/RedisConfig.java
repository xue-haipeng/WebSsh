...
public class RedisConfig {
    ...
    public CacheManager cacheManager() {
        return new ConcurrentMapCacheManager("wls_findByHostnameLike", "countWlsHosts", "countWlsInstances", "countWlsRunning",
                ...
                "average6_cp6", "average6_cpf", "average6_cpo", "max6_emp", "max6_osp", "max6_cop", "max6_ep9", "max6_zyp", "max6_ep1", "max6_ep4",
                "max6_tkm", "max6_ep6", "max6_ep7", "max6_cp6", "max6_cpf", "max6_cpo", "ascsCpuCurrFindAll");
    }
}
