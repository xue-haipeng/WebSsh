(function($) {
  ...
  function initPagination() {
    ...
    var pageHtml = '<div id="switch"><ul id="ul_sys_type"><li id="sys_type"> 生产系统备份 </li></ul><ul id="pages"><li class="active"></li>'
  ...
  function paginationHandler() {
    ...
    //显示系统名称
    if (iIndex == 0) {$('#sys_type').text('生产系统备份');}
    if (iIndex == 1) {$('#sys_type').text('测试系统备份');}
    if (iIndex == 2) {$('#sys_type').text('开发系统备份');}
    if (iIndex == 3) {$('#sys_type').text('回归测试系统');}
  }
