...
$.fn.panel.defaults={id:null,title:null,iconCls:null,width:"auto",height:"auto",left:null,top:null,cls:null,headerCls:null,bodyCls:null,style:{},href:null,cache:true,fit:false,border:true,doSize:true,noheader:false,content:null,collapsible:false,minimizable:false,maximizable:false,closable:false,collapsed:false,minimized:false,maximized:false,closed:false,openAnimation:false,openDuration:0,closeAnimation:false,closeDuration:0,tools:null,footer:null,queryParams:{},method:"get",href:null,loadingMessage:"Loading...",loader:function(_257,_258,_259){
...
var isTitle = "&nbsp;";
var text = $(_3a1[_39f]).context.attributes["data-options"].value.split(",");
var text2 = null;
for(var i=0;i<text.length;i++){
	if(text[i].indexOf("title")>=0){
		text2 = text[i].split(":")
		break;
	}
}
if(text2!=null){
	var text3 = text2[text2.length-1];
	var text4 = text3.replace("\'","").replace("\'","");
	if(dir =="south" || dir == "north")
		isTitle = text4;
}

p.panel($.extend({},$.fn.layout.paneldefaults,{cls:("layout-expand layout-expand-"+dir),title:isTitle,closed:true,minWidth:0,minHeight:0,doSize:false,tools:[{iconCls:icon,handler:function(){
_3ad(_39e,_39f);
return false;
}}]}));
...
var opts=$(this).combobox("options");
return row[opts.textField].toLowerCase().indexOf(q.toLowerCase())>-1;//从头开始匹配改为任意位置匹配
