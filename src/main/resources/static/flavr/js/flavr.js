; (function($) {
    ...
    $.flavr = function() {
        ...
        var L = function() {
            ...
            if (true == w.settings.closeOverlay) h.on('click', 
            function() {
                w.close()
            });
            ...
            if (w.settings.buttons !== false) $.each(w.settings.buttons, 
            function(c, d) {
                var f = {},
                btn = t.clone();
                if (D(this)) {
